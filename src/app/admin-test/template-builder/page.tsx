    ...
    <div style={{ maxWidth: 640, margin: "24px auto", padding: 16, fontFamily: "sans-serif" }}>
      ...
      <form onSubmit={handleSave}>
        ...
        <button type="submit" disabled={saving} style={{ padding: 14, fontSize: 16, width: "100%" }}>
          {saving ? "저장 중..." : editingTemplateId ? "템플릿 수정 저장" : "템플릿 저장"}
        </button>
      </form>
        ...
        <div key={t.templateId} style={{ marginBottom: 16 }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            ...
            <div style={{ display: "flex", gap: 6 }}>
              <button type="button" onClick={() => loadForEdit(t)} style={{ fontSize: 12, padding: "3px 8px" }}>
                수정
              </button>
              <button
                type="button"
                onClick={() => handleDeleteTemplate(t.templateId, t.name)}
